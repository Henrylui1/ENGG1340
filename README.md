...
## Some Limitaions
1. The input must follow the format, e.g. you must not type enything other than whole numbers under "age".\nFor "name" and "role", you can type spaces but for function 7 (custom attributes) , you CANNOT.
